...
echo "4. Configure:"
echo "   - Endpoint URL: https://shopmatch.highencodelearning.com/api/stripe/webhook"
...
echo "   stripe listen --forward-to https://shopmatch.highencodelearning.com/api/stripe/webhook"
echo ""
